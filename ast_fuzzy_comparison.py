...
def main():
    ...
    prog1 = "/Users/pedrosalazar/Downloads/calculadora_indices 2.py"
    prog2 = "/Users/pedrosalazar/Downloads/calculadora_indices.py"
    ...
    print(
        f'The index of similarity between {prog1} and {prog2} is: {similarity}'
    )
